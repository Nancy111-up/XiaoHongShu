...
from src.db.models import Note, Opportunity, TopicSnapshot, TopicSnapshotNote
        ...
        async with sessions() as session:
            rows = list(
                await session.execute(
                    select(Opportunity, TopicSnapshot)
            ...
            items = []
            for opportunity, snapshot in rows:
                urls = list(
            ...
            return {"items": items, "data_source": "live"}
